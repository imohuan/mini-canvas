...
<template>
  ...
  <div :class="rowItem"><span>半径</span><input type="range" min="40" max="120" :value="handleRadius" class="w-24 h-1 accent-[#3b82f6]" @input="emit('update:handleRadius', Number(($event.target as HTMLInputElement).value))" /><span class="text-[11px] text-[#78767b] w-8 text-right font-mono">{{ handleRadius }}</span></div>
  <div :class="rowItem"><span>静止偏移</span><input type="range" min="10" max="60" :value="handleRestOffset" class="w-24 h-1 accent-[#3b82f6]" @input="emit('update:handleRestOffset', Number(($event.target as HTMLInputElement).value))" /><span class="text-[11px] text-[#78767b] w-8 text-right font-mono">{{ handleRestOffset }}</span></div>
  <div :class="rowItem"><span>光标间隙</span><input type="range" min="10" max="60" :value="handleCursorGap" class="w-24 h-1 accent-[#3b82f6]" @input="emit('update:handleCursorGap', Number(($event.target as HTMLInputElement).value))" /><span class="text-[11px] text-[#78767b] w-8 text-right font-mono">{{ handleCursorGap }}</span></div>
  <div :class="rowItem"><span>按钮大小</span><input type="range" min="16" max="48" :value="handleButtonSize" class="w-24 h-1 accent-[#3b82f6]" @input="emit('update:handleButtonSize', Number(($event.target as HTMLInputElement).value))" /><span class="text-[11px] text-[#78767b] w-8 text-right font-mono">{{ handleButtonSize }}</span></div>
  <div :class="rowItem"><span>重叠</span><input type="range" min="0" max="40" :value="handleOverlap" class="w-24 h-1 accent-[#3b82f6]" @input="emit('update:handleOverlap', Number(($event.target as HTMLInputElement).value))" /><span class="text-[11px] text-[#78767b] w-8 text-right font-mono">{{ handleOverlap }}</span></div>
  ...
  <div :class="rowItem"><span>外比例</span><input type="range" min="0.1" max="1.5" step="0.05" :value="connectionSnapOuterRatio" class="w-24 h-1 accent-[#3b82f6]" @input="emit('update:connectionSnapOuterRatio', Number(($event.target as HTMLInputElement).value))" /><span class="text-[11px] text-[#78767b] w-8 text-right font-mono">{{ connectionSnapOuterRatio }}</span></div>
  <div :class="rowItem"><span>内比例</span><input type="range" min="0.1" max="1" step="0.05" :value="connectionSnapInnerRatio" class="w-24 h-1 accent-[#3b82f6]" @input="emit('update:connectionSnapInnerRatio', Number(($event.target as HTMLInputElement).value))" /><span class="text-[11px] text-[#78767b] w-8 text-right font-mono">{{ connectionSnapInnerRatio }}</span></div>
  <div :class="rowItem"><span>高比例</span><input type="range" min="0.5" max="2" step="0.05" :value="connectionSnapHeightRatio" class="w-24 h-1 accent-[#3b82f6]" @input="emit('update:connectionSnapHeightRatio', Number(($event.target as HTMLInputElement).value))" /><span class="text-[11px] text-[#78767b] w-8 text-right font-mono">{{ connectionSnapHeightRatio }}</span></div>

  <!-- 框选 -->
  <div :class="sectionTitle">框选</div>
  <div :class="rowItem"><span>内边距X</span><input type="range" min="0" max="60" :value="selectionFramePaddingX" class="w-24 h-1 accent-[#3b82f6]" @input="emit('update:selectionFramePaddingX', Number(($event.target as HTMLInputElement).value))" /><span class="text-[11px] text-[#78767b] w-8 text-right font-mono">{{ selectionFramePaddingX }}</span></div>
  <div :class="rowItem"><span>内边距顶</span><input type="range" min="0" max="60" :value="selectionFramePaddingTop" class="w-24 h-1 accent-[#3b82f6]" @input="emit('update:selectionFramePaddingTop', Number(($event.target as HTMLInputElement).value))" /><span class="text-[11px] text-[#78767b] w-8 text-right font-mono">{{ selectionFramePaddingTop }}</span></div>
  <div :class="rowItem"><span>内边距底</span><input type="range" min="0" max="60" :value="selectionFramePaddingBottom" class="w-24 h-1 accent-[#3b82f6]" @input="emit('update:selectionFramePaddingBottom', Number(($event.target as HTMLInputElement).value))" /><span class="text-[11px] text-[#78767b] w-8 text-right font-mono">{{ selectionFramePaddingBottom }}</span></div>
</template>