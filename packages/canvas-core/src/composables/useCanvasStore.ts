  ...
  read(raw: string) {
    ...
    return {
      core: {
        ...
        edgeLineWidth: numberOr(core.edgeLineWidth, 2),
        ...
        edgeMarkerSize: numberOr(core.edgeMarkerSize, 8),
        edgeVisible: core.edgeVisible ?? true,
        edgeStepOffset: numberOr(core.edgeStepOffset, 20),
        edgeSmoothRadius: numberOr(core.edgeSmoothRadius, 5),
        edgeGlowEnabled: core.edgeGlowEnabled ?? true,
        edgeGlowIntensity: numberOr(core.edgeGlowIntensity, 1),
        edgeGlowColor: core.edgeGlowColor ?? '#ffffff',
        topToolbarOffset: numberOr(core.topToolbarOffset, 12),
        ...
        minZoom: numberOr(core.minZoom, 0.1),
        maxZoom: numberOr(core.maxZoom, 4),
        zoomOnScroll: core.zoomOnScroll ?? true,
        panOnScroll: core.panOnScroll ?? false,
        panOnDrag: core.panOnDrag ?? true,
        panOnRightDrag: core.panOnRightDrag ?? false,
