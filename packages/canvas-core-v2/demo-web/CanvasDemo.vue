...
import { NODE_REGISTRY_KEY, NODE_WRITE_KEY } from '../src/contracts/nodeRegistryKey'
import { CANVAS_PARAMS_KEY } from '../src/contracts/canvasParamKey'
...
import { EDGE_VISUAL_KEY, EDGE_SELECTION_KEY, type EdgeVisual } from '../src/contracts/edgeContext'
